...
internal class SteamItemStore : ItemStore
{
    ...
    public override void ViewItem(int itemdefid)
    {
        ...
        WebUtils.OpenURL("https://store.steampowered.com/itemstore/" + Provider.APP_ID.ToString() + "/detail/" + itemdefid);
    }
    ...
    public override void ViewNewItems()
    {
        ...
        WebUtils.OpenURL("https://store.steampowered.com/itemstore/" + Provider.APP_ID.ToString() + "/browse/?filter=New");
    }
    ...
    public override void ViewStore()
    {
        ...
        WebUtils.OpenURL("https://store.steampowered.com/itemstore/" + Provider.APP_ID.ToString());
    }
